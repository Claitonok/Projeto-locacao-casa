...
<!-- <link rel="stylesheet" type="text/css" href="./css/pagLogin.css"> -->
<link rel="stylesheet" type="text/css" href="./CSSTest/styLogin.css">
...
<body>
	...
	<form action="Home_acomo_Servlet" method="post"
		...
		<div class="row mb-3">
			<div class="col-sm-10">
				...
				<input placeholder="exemplo@exemplo.com" type="email"
					...
					onkeyup="checkEmail(this.value)" id="inputEmail">
		...
		<div class="row mb-3">
			<div class="password-wrapper col-sm-10">
				<!-- 147 -->
				<input type="password" name="txtsenha" placeholder="Senha" class="form-control" onkeyup="checkPassword(this.value)" id="pswrd" required>
				<i class="fa-solid fa-eye toggle-password" data-target="pswrd"></i>
			
			<input value="aceito" class="form-check-input" type="checkbox" id="gridCheck1" required> 
			<label class="form-check-label" for="gridCheck1">Termos e Politica</label>
		...
		<c:if test="${not empty validar}">
			...
			<div class="toast-container position-fixed top-0 end-0 p-3">
				...
				<div id="liveToast"
					...
					<div class="d-flex">
						<div class="toast-body">❌ Operação não realizada! ${validar}</div>
						<button type="button"
	...
	<div id="link_cadastra">
		<a
			href="http://localhost:8080/Home_acomodacao/Home_acomo_Servlet?acao=cadastrarUser">Sign-up</a>
		| <a
			href="http://localhost:8080/Home_acomodacao/Home_acomo_Servlet?acao=AlterarSenhaUser">Change-Password</a>
	</div>
